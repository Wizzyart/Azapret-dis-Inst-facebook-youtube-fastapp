...
Основной порт Telegram proxy - `1443`. Если он уже занят другой программой, Azapret автоматически попробует следующий свободный порт:

```text
1443, 2443, 3443, 8443, 9443, 10443
```

Пользователю ничего вручную менять не нужно: Azapret сохранит выбранный порт и откроет Telegram уже с правильной ссылкой.
