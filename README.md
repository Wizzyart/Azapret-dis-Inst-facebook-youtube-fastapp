...
Это не официальный репозиторий `bol-van/zapret`. Azapret FastApp - независимая Windows-оболочка и готовая Public-сборка с UI, профилями и сервисными кнопками. Оригинальный низкоуровневый zapret находится здесь: `https://github.com/bol-van/zapret`, актуальная ветка upstream - `https://github.com/bol-van/zapret2`.
