...
Основной локальный порт Telegram proxy - `1443`.

Если `1443` уже занят другой программой, Azapret автоматически выберет следующий свободный порт из списка:

```text
1443, 2443, 3443, 8443, 9443, 10443
```

После выбора свободного порта Azapret сохранит его в настройках и откроет Telegram уже с правильной proxy-ссылкой. Вручную менять порт в Telegram не нужно.
