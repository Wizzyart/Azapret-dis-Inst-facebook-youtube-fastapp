@echo off
chcp 65001 > nul
:: Azapret Public edition - FACEIT/CS2 UDP fix profile TTL7
:: Based on https://github.com/reateroff/zapret-game-udp-fix - TTL 7
...
--filter-udp=1024-65535 --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake --dpi-desync-repeats=10 --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n4 --dpi-desync-ttl=7 --dpi-desync-fake-unknown-udp="%BIN%stun.bin"
