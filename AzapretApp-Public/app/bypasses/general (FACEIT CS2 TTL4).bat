@echo off
chcp 65001 > nul
:: Azapret Public edition - FACEIT/CS2 UDP fix profile TTL4
:: Based on https://github.com/reateroff/zapret-game-udp-fix - TTL 4
...
start "azapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,1024 --wf-udp=443,19294-19344,50000-50100,1024-65535 ^
...
--filter-udp=1024-65535 --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake --dpi-desync-repeats=10 --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n4 --dpi-desync-ttl=4 --dpi-desync-fake-unknown-udp="%BIN%stun.bin"
